      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-foreground/60 text-sm mb-4 font-sans">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-foreground/40 text-sm mb-4 md:mb-0 font-sans">
              &copy; {currentYear} Dev Spark. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <a href="#" className="text-foreground/40 hover:text-accent text-sm font-sans">Privacy Policy</a>
              <a href="#" className="text-foreground/40 hover:text-accent text-sm font-sans">Terms of Service</a>
              <a href="#" className="text-foreground/40 hover:text-accent text-sm font-sans">Cookie Policy</a>
            </div>
          </div>
        </motion.div>
      </div>
